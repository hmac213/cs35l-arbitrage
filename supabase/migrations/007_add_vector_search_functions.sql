-- Migration: 007_add_vector_search_functions
-- Description: Add PostgreSQL functions for vector operations that can be called via RPC

-- Function to update market embedding
-- Accepts embedding as TEXT and casts to vector type
...
-- Function to delete market embedding
CREATE OR REPLACE FUNCTION delete_market_embedding(
    market_uuid UUID
)
RETURNS void
LANGUAGE plpgsql
